class User < ActiveRecord::Base
  ...
  has_attached_file :avatar,:default_url => "/assets/avatars/missing_thumb.png", :styles => { :medium => "300x300>", :thumb => "100x100>" }, :s3_credentials => Proc.new{|a| a.instance.s3_credentials }
