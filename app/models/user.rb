class User < ActiveRecord::Base
  ...
  has_attached_file :avatar, :styles => { :medium => "300x300>", :thumb => "100x100>" }, :s3_credentials => Proc.new{|a| a.instance.s3_credentials },:default_url => '/images/:attachment/missing_:style.png'
